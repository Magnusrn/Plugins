...
public enum CraftingMethods {
    ...
    Sapphire_Amulet(ItemID.GOLD_BAR,ItemID.EMERALD,ItemID.SAPPHIRE_AMULET_U,29229094),
    Emerald_Amulet(ItemID.GOLD_BAR,ItemID.SODA_ASH,ItemID.EMERALD_AMULET_U,29229095),
    ...
    Gold_Bracelet(ItemID.GOLD_BAR,ItemID.GOLD_BRACELET,29229106),
    Sapphire_Bracelet(ItemID.GOLD_BAR,ItemID.EMERALD,ItemID.SAPPHIRE_BRACELET,29229108),
    Emerald_Bracelet(ItemID.GOLD_BAR,ItemID.SODA_ASH,ItemID.EMERALD_BRACELET,29229109),
    ...
    Gold_Bar(ItemID.GOLD_BAR,ItemID.GOLD_BAR,17694739),
